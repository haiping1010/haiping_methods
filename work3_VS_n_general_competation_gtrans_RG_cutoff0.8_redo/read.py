...
for name in  arr_name:
   pocket_graph[name[0:4]] =pdb_graph(name)
...
class TestbedDataset(InMemoryDataset):
    def __init__(self, root='/tmp', dataset='davis', 
                 ...
                 pre_transform=None,pocket_graph=None):
    ...
    def process(self, xd,pocket_graph):
        ...
        for i in range(data_len):
            ...
            c_size, features, edge_index = pocket_graph[filename[0:4]]
...
train_data = TestbedDataset(root='data1', dataset='pocket_train', xd=arr_name, pocket_graph=pocket_graph)
