...
class GCNNet(torch.nn.Module):
    ...
    def __init__(self, n_output=1, n_filters=64, embed_dim=1280,num_features_xd=75,edge_dim_xd=20, output_dim=1280, dropout=0.2):
        ...
        self.conv1 = TransformerConv(num_features_xd, num_features_xd ,heads=5, concat=True, dropout=0.1)
        self.conv2 = TransformerConv(num_features_xd*5, num_features_xd*10,heads=10, concat=True, dropout=0.1)
